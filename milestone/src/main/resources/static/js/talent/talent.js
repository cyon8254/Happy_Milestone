...
window.onload = function () {
    ...
    $(".education").css({"color":"rgb(154, 155, 167)"})

    $(".exercise").css({"font-weight":"normal"})
    $(".exercise").css({"color":"rgb(154, 155, 167)"})

    $(".music").css({"font-weight":"normal"})
    $(".music").css({"color":"rgb(154, 155, 167)"})

    $(".art").css({"font-weight":"normal"})
    $(".art").css({"color":"rgb(154, 155, 167)"})

    $(".program").css({"font-weight":"normal"})
    $(".program").css({"color":"rgb(154, 155, 167)"})
